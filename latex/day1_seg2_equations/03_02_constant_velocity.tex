...
\begin{frame}
  ...
  \onslide<2->{
\begin{figure}
  \includegraphics[width=0.85\textwidth]{\dayonesegtwo/const_vel_w_less_proc_noise_30_samples.png}
\end{figure}
}
\onslide<3->{\center --------------------------------------------------------------------}
\end{frame}
...
\begin{frame}
  ...
  \onslide<2->{
\begin{figure}
  \includegraphics[width=0.85\textwidth]{\dayonesegtwo/const_vel_sawtooth_w_proc_noise_30_samples.png}
\end{figure}
}
\onslide<3->{\center --------------------------------------------------------------------}
\end{frame}
